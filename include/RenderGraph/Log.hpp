...
namespace crg
{
	...
	public:
		...
		*	Logs a trace message.
		*/
		CRG_API static void logTrace( std::ostream const & message, bool newLine = true );
		/**
		*\brief
		*	Logs a debug message.
		*/
		CRG_API static void logDebug( std::ostream const & message, bool newLine = true );
		/**
		*\brief
		*	Logs an info message.
		*/
		CRG_API static void logInfo( std::ostream const & message, bool newLine = true );
		/**
		*\brief
		*	Logs a warning message.
		*/
		CRG_API static void logWarning( std::ostream const & message, bool newLine = true );
		/**
		*\brief
		*	Logs an error message.
		*/
		CRG_API static void logError( std::ostream const & message, bool newLine = true );
		/**
		*\brief
	...
	namespace log
	{
		...
		public:
			...
			LogStreambufT( LogStreambufT && ) = delete;
			LogStreambufT & operator=( LogStreambufT && ) = delete;
