...
*/
#ifndef ___Utils_EXCEPTION_H___
#define ___Utils_EXCEPTION_H___
...
\date 		03/01/2011
\~english
\brief		Macro to ease the use of utils::Exception
\~french
\brief		Macro définie pour faciliter l'utilisation de utils::Exception
*/
#define CASTOR_EXCEPTION( p_text ) throw utils::Exception( (p_text), __FILE__, __FUNCTION__, __LINE__ )
