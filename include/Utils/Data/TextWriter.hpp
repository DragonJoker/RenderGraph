...
*/
#ifndef ___Utils_TEXT_WRITER_H___
#define ___Utils_TEXT_WRITER_H___
...
namespace utils
{
	...
	\date		31/05/2016
	\~english
	\brief		Partial utils::Writer specialisation for text files
	\~french
	\brief		Spécialisation partielle de utils::Writer, pour les fichiers texte
	*/
	template< class T >
	class TextWriter
