...
*/
#ifndef ___Utils_PATH_H___
#define ___Utils_PATH_H___
...
namespace utils
{
	...
	*/
	...
	public:
		 ...
		 */
		explicit Path( char const * p_data );
		/**
		 *\~english
		 ...
		 */
		explicit Path( wchar_t const * p_data );
		/**
		 *\~english
		 ...
		 */
		explicit Path( String const & p_data );
		/**
		 *\~english
		 ...
		 */
		Path & operator/=( char const * p_buffer );
		/**
		 *\~english
		 ...
		 *\param[in]	p_buffer	La chaîne de caractères C à concaténer
		 */
		Path & operator/=( wchar_t const * p_buffer );
		/**
		 *\~english
		 ...
		 *\return		La feuille.
		 */
		Path getFileName( bool p_withExtension = false )const;
		/**
		 *\~english
