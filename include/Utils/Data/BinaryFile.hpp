...
*/
#ifndef ___Utils_BINARY_FILE___
#define ___Utils_BINARY_FILE___
...
namespace utils
{
	...
	*/
	...
	public:
		 ...
		 */
		BinaryFile( Path const & p_fileName
		 ...
		 */
		bool write( String const & p_toWrite );
		/**
		 *\~english
