...
*/
#ifndef ___Utils_PARSER_PARAMETER_HELPERS_H___
#define ___Utils_PARSER_PARAMETER_HELPERS_H___
...
namespace utils
{
	...
	*/
	...
	{
		static xchar const * const Value;
	};
	/*!
	\author		Sylvain DOREMUS
	\version	0.8.0
	...
	*/
	template<> struct ParserParameterHelper< ParameterType::eText >
	{
		...
		static const ParameterType ParamType = ParameterType::eText;
		//!~english The parameter type name.	\~french Le nom du type de paramètre.
		static xchar const * const StringType;
	};
	/*!
	\author 	Sylvain DOREMUS
	\date 		12/02/2016
	...
	*/
	template<> struct ParserParameterHelper< ParameterType::eName >
	{
		...
		using ValueType = String;
		//!~english The parameter type.	\~french Le type de paramètre.
		static const ParameterType ParamType = ParameterType::eName;
		//!~english The parameter type.	\~french Le type de paramètre.
		static const ParameterType ParameterBaseType = ParameterType::eText;
		//!~english The parameter type name.	\~french Le nom du type de paramètre.
		static xchar const * const StringType;
	};
	/*!
	...
	*/
	template<> struct ParserParameterHelper< ParameterType::ePath >
	{
		...
		//!~english The parameter type.	\~french Le type de paramètre.
		static const ParameterType ParamType = ParameterType::ePath;
		//!~english The parameter type name.	\~french Le nom du type de paramètre.
		static xchar const * const StringType;
	};
	/*!
	...
	*/
	template<> struct ParserParameterHelper< ParameterType::eCheckedText >
	{
		...
		//!~english The parameter type.	\~french Le type de paramètre.
		static const ParameterType ParamType = ParameterType::eCheckedText;
		//!~english The parameter base type.	\~french Le type de base du paramètre.
		static const ParameterType ParameterBaseType = ParameterType::eUInt32;
		//!~english The parameter type name.	\~french Le nom du type de paramètre.
		static xchar const * const StringType;
	};
	/*!
	...
	*/
	template<> struct ParserParameterHelper< ParameterType::eBitwiseOred32BitsCheckedText >
	{
		...
		using ValueType = uint32_t;
		//!~english The parameter type.	\~french Le type de paramètre.
		static const ParameterType ParamType = ParameterType::eBitwiseOred32BitsCheckedText;
		//!~english The parameter base type.	\~french Le type de base du paramètre.
		static const ParameterType ParameterBaseType = ParameterType::eUInt32;
		//!~english The parameter type name.	\~french Le nom du type de paramètre.
		static xchar const * const StringType;
	...
	*/
	template<> struct ParserParameterHelper< ParameterType::eBitwiseOred64BitsCheckedText >
	{
		...
		//!~english The parameter type.	\~french Le type de paramètre.
		static const ParameterType ParamType = ParameterType::eBitwiseOred64BitsCheckedText;
		//!~english The parameter base type.	\~french Le type de base du paramètre.
		static const ParameterType ParameterBaseType = ParameterType::eUInt64;
		//!~english The parameter type name.	\~french Le nom du type de paramètre.
		static xchar const * const StringType;
	};
	/*!
	...
	*/
	template<> struct ParserParameterHelper< ParameterType::eBool >
	{
		...
		//!~english The parameter type.	\~french Le type de paramètre.
		static const ParameterType ParamType = ParameterType::eBool;
		//!~english The parameter type name.	\~french Le nom du type de paramètre.
		static xchar const * const StringType;
	};
	/*!
	...
	*/
	template<> struct ParserParameterHelper< ParameterType::eInt8 >
	{
		...
		//!~english The parameter type.	\~french Le type de paramètre.
		static const ParameterType ParamType = ParameterType::eInt8;
		//!~english The parameter type name.	\~french Le nom du type de paramètre.
		static xchar const * const StringType;
	};
	/*!
	...
	*/
	template<> struct ParserParameterHelper< ParameterType::eInt16 >
	{
		...
		//!~english The parameter type.	\~french Le type de paramètre.
		static const ParameterType ParamType = ParameterType::eInt16;
		//!~english The parameter type name.	\~french Le nom du type de paramètre.
		static xchar const * const StringType;
	};
	/*!
	...
	*/
	template<> struct ParserParameterHelper< ParameterType::eInt32 >
	{
		...
		//!~english The parameter type.	\~french Le type de paramètre.
		static const ParameterType ParamType = ParameterType::eInt32;
		//!~english The parameter type name.	\~french Le nom du type de paramètre.
		static xchar const * const StringType;
	};
	/*!
	...
	*/
	template<> struct ParserParameterHelper< ParameterType::eInt64 >
	{
		...
		//!~english The parameter type.	\~french Le type de paramètre.
		static const ParameterType ParamType = ParameterType::eInt64;
		//!~english The parameter type name.	\~french Le nom du type de paramètre.
		static xchar const * const StringType;
	};
	/*!
	...
	*/
	template<> struct ParserParameterHelper< ParameterType::eUInt8 >
	{
		...
		//!~english The parameter type.	\~french Le type de paramètre.
		static const ParameterType ParamType = ParameterType::eUInt8;
		//!~english The parameter type name.	\~french Le nom du type de paramètre.
		static xchar const * const StringType;
	};
	/*!
	...
	*/
	template<> struct ParserParameterHelper< ParameterType::eUInt16 >
	{
		...
		//!~english The parameter type.	\~french Le type de paramètre.
		static const ParameterType ParamType = ParameterType::eUInt16;
		//!~english The parameter type name.	\~french Le nom du type de paramètre.
		static xchar const * const StringType;
	};
	/*!
	...
	*/
	template<> struct ParserParameterHelper< ParameterType::eUInt32 >
	{
		...
		using ValueType = uint32_t;
		//!~english The parameter type.	\~french Le type de paramètre.
		static const ParameterType ParamType = ParameterType::eUInt32;
		//!~english The parameter type name.	\~french Le nom du type de paramètre.
		static xchar const * const StringType;
	};
	/*!
	...
	*/
	template<> struct ParserParameterHelper< ParameterType::eUInt64 >
	{
		...
		using ValueType = uint64_t;
		//!~english The parameter type.	\~french Le type de paramètre.
		static const ParameterType ParamType = ParameterType::eUInt64;
		//!~english The parameter type name.	\~french Le nom du type de paramètre.
		static xchar const * const StringType;
	};
	/*!
	...
	*/
	template<> struct ParserParameterHelper< ParameterType::eFloat >
	{
		...
		//!~english The parameter type.	\~french Le type de paramètre.
		static const ParameterType ParamType = ParameterType::eFloat;
		//!~english The parameter type name.	\~french Le nom du type de paramètre.
		static xchar const * const StringType;
	};
	/*!
	...
	*/
	template<> struct ParserParameterHelper< ParameterType::eDouble >
	{
		...
		//!~english The parameter type.	\~french Le type de paramètre.
		static const ParameterType ParamType = ParameterType::eDouble;
		//!~english The parameter type name.	\~french Le nom du type de paramètre.
		static xchar const * const StringType;
	};
	/*!
	...
	*/
	template<> struct ParserParameterHelper< ParameterType::eLongDouble >
	{
		...
		//!~english The parameter type.	\~french Le type de paramètre.
		static const ParameterType ParamType = ParameterType::eLongDouble;
		//!~english The parameter type name.	\~french Le nom du type de paramètre.
		static xchar const * const StringType;
	};
	/*!
	...
	*/
	...
	{
		//!~english The parameter value type.	\~french Le type de valeur du paramètre.
		using ValueType = ashes::Format;
		//!~english The parameter type.	\~french Le type de paramètre.
		static const ParameterType ParamType = ParameterType::ePixelFormat;
		//!~english The parameter type name.	\~french Le nom du type de paramètre.
		static xchar const * const StringType;
	};
	/*!
	...
	*/
	template<> struct ParserParameterHelper< ParameterType::ePoint2I >
	{
		...
		//!~english The parameter type.	\~french Le type de paramètre.
		static const ParameterType ParamType = ParameterType::ePoint2I;
		//!~english The parameter type name.	\~french Le nom du type de paramètre.
		static xchar const * const StringType;
	};
	/*!
	...
	*/
	template<> struct ParserParameterHelper< ParameterType::ePoint3I >
	{
		...
		//!~english The parameter type.	\~french Le type de paramètre.
		static const ParameterType ParamType = ParameterType::ePoint3I;
		//!~english The parameter type name.	\~french Le nom du type de paramètre.
		static xchar const * const StringType;
	};
	/*!
	...
	*/
	template<> struct ParserParameterHelper< ParameterType::ePoint4I >
	{
		...
		//!~english The parameter type.	\~french Le type de paramètre.
		static const ParameterType ParamType = ParameterType::ePoint4I;
		//!~english The parameter type name.	\~french Le nom du type de paramètre.
		static xchar const * const StringType;
	};
	/*!
	...
	*/
	template<> struct ParserParameterHelper< ParameterType::ePoint2F >
	{
		...
		//!~english The parameter type.	\~french Le type de paramètre.
		static const ParameterType ParamType = ParameterType::ePoint2F;
		//!~english The parameter type name.	\~french Le nom du type de paramètre.
		static xchar const * const StringType;
	};
	/*!
	...
	*/
	template<> struct ParserParameterHelper< ParameterType::ePoint3F >
	{
		...
		//!~english The parameter type.	\~french Le type de paramètre.
		static const ParameterType ParamType = ParameterType::ePoint3F;
		//!~english The parameter type name.	\~french Le nom du type de paramètre.
		static xchar const * const StringType;
	};
	/*!
	...
	*/
	template<> struct ParserParameterHelper< ParameterType::ePoint4F >
	{
		...
		//!~english The parameter type.	\~french Le type de paramètre.
		static const ParameterType ParamType = ParameterType::ePoint4F;
		//!~english The parameter type name.	\~french Le nom du type de paramètre.
		static xchar const * const StringType;
	};
	/*!
	...
	*/
	template<> struct ParserParameterHelper< ParameterType::ePoint2D >
	{
		...
		//!~english The parameter type.	\~french Le type de paramètre.
		static const ParameterType ParamType = ParameterType::ePoint2D;
		//!~english The parameter type name.	\~french Le nom du type de paramètre.
		static xchar const * const StringType;
	};
	/*!
	...
	*/
	template<> struct ParserParameterHelper< ParameterType::ePoint3D >
	{
		...
		//!~english The parameter type.	\~french Le type de paramètre.
		static const ParameterType ParamType = ParameterType::ePoint3D;
		//!~english The parameter type name.	\~french Le nom du type de paramètre.
		static xchar const * const StringType;
	};
	/*!
	...
	*/
	template<> struct ParserParameterHelper< ParameterType::ePoint4D >
	{
		...
		//!~english The parameter type.	\~french Le type de paramètre.
		static const ParameterType ParamType = ParameterType::ePoint4D;
		//!~english The parameter type name.	\~french Le nom du type de paramètre.
		static xchar const * const StringType;
	};
	/*!
	...
	*/
	template<> struct ParserParameterHelper< ParameterType::eSize >
	{
		...
		//!~english The parameter type.	\~french Le type de paramètre.
		static const ParameterType ParamType = ParameterType::eSize;
		//!~english The parameter type name.	\~french Le nom du type de paramètre.
		static xchar const * const StringType;
	};
	/*!
	...
	*/
	template<> struct ParserParameterHelper< ParameterType::ePosition >
	{
		...
		//!~english The parameter type.	\~french Le type de paramètre.
		static const ParameterType ParamType = ParameterType::ePosition;
		//!~english The parameter type name.	\~french Le nom du type de paramètre.
		static xchar const * const StringType;
	};
	/*!
	...
	*/
	template<> struct ParserParameterHelper< ParameterType::eRectangle >
	{
		...
		//!~english The parameter type.	\~french Le type de paramètre.
		static const ParameterType ParamType = ParameterType::eRectangle;
		//!~english The parameter type name.	\~french Le nom du type de paramètre.
		static xchar const * const StringType;
	};
	/*!
	...
	*/
	template<> struct ParserParameterHelper< ParameterType::eRgbColour >
	{
		...
		//!~english The parameter type.	\~french Le type de paramètre.
		static const ParameterType ParamType = ParameterType::eRgbColour;
		//!~english The parameter type name.	\~french Le nom du type de paramètre.
		static xchar const * const StringType;
	};
	/*!
	...
	*/
	template<> struct ParserParameterHelper< ParameterType::eRgbaColour >
	{
		...
		//!~english The parameter type.	\~french Le type de paramètre.
		static const ParameterType ParamType = ParameterType::eRgbaColour;
		//!~english The parameter type name.	\~french Le nom du type de paramètre.
		static xchar const * const StringType;
	};
	/*!
	...
	*/
	template<> struct ParserParameterHelper< ParameterType::eHdrRgbColour >
	{
		...
		//!~english The parameter type.	\~french Le type de paramètre.
		static const ParameterType ParamType = ParameterType::eHdrRgbColour;
		//!~english The parameter type name.	\~french Le nom du type de paramètre.
		static xchar const * const StringType;
	};
	/*!
	...
	*/
	template<> struct ParserParameterHelper< ParameterType::eHdrRgbaColour >
	{
		...
		//!~english The parameter type.	\~french Le type de paramètre.
		static const ParameterType ParamType = ParameterType::eHdrRgbaColour;
		//!~english The parameter type name.	\~french Le nom du type de paramètre.
		static xchar const * const StringType;
	};
	/*!
