...
*/
#ifndef ___Utils_PARSER_PARAMETER_H___
#define ___Utils_PARSER_PARAMETER_H___
...
namespace utils
{
	...
	*/
	...
	public:
		...
		/**
		 *\copydoc		utils::ParserParameterBase::getType
		 */
		...
		/**
		 *\copydoc		utils::ParserParameterBase::getStrType
		 */
		...
		/**
		 *\copydoc		utils::ParserParameterBase::clone
		 */
		...
		/**
		 *\copydoc		utils::ParserParameterBase::parse
		 */
	...
	*/
	...
	public:
		...
		inline ParameterType getType();
		/**
		 *\copydoc		utils::ParserParameterBase::getBaseType
		 */
