...
*/
#ifndef ___Utils_PARSER_PARAMETER_BASE_H___
#define ___Utils_PARSER_PARAMETER_BASE_H___
...
namespace utils
{
	...
	*/
	...
	public:
		 ...
		 *\return		Le type.
		 */
		virtual ParameterType getBaseType()
		{
			return getType();
		}
		/**
		 ...
		 *\return		Le type.
		 */
		virtual xchar const * const getStrType() = 0;
		/**
		 *\~english
		 ...
		 */
		virtual ParserParameterBaseSPtr clone() = 0;
		/**
		 *\~english
		 ...
		 */
		virtual bool parse( String & p_params ) = 0;
		/**
		 *\~english
