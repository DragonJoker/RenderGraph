...
#include "Utils/Graphics/Colour.hpp"
...
namespace utils
{
	...
	*/
	...
	\~english
	\brief		Retrieves parameter type from c++ type.
	\remarks	Specialisation for utils::String.
	\~french
	\brief		Récupère le type de paramètre à partir du type C++.
	\remarks	Spécialisation pour utils::String.
	*/
	template<>
	...
	\~english
	\brief		Retrieves parameter type from c++ type.
	\remarks	Specialisation for utils::Path.
	\~french
	\brief		Récupère le type de paramètre à partir du type C++.
	\remarks	Spécialisation pour utils::Path.
	*/
	template<>
	...
	*/
	...
	\~english
	\brief		Retrieves parameter type from c++ type.
	\remarks	Specialisation for utils::Point2i.
	\~french
	\brief		Récupère le type de paramètre à partir du type C++.
	\remarks	Spécialisation pour utils::Point2i.
	*/
	template<>
	...
	\~english
	\brief		Retrieves parameter type from c++ type.
	\remarks	Specialisation for utils::Point3i.
	\~french
	\brief		Récupère le type de paramètre à partir du type C++.
	\remarks	Spécialisation pour utils::Point3i.
	*/
	template<>
	...
	\~english
	\brief		Retrieves parameter type from c++ type.
	\remarks	Specialisation for utils::Point4i.
	\~french
	\brief		Récupère le type de paramètre à partir du type C++.
	\remarks	Spécialisation pour utils::Point4i.
	*/
	template<>
	...
	\~english
	\brief		Retrieves parameter type from c++ type.
	\remarks	Specialisation for utils::Point2f.
	\~french
	\brief		Récupère le type de paramètre à partir du type C++.
	\remarks	Spécialisation pour utils::Point2f.
	*/
	template<>
	...
	\~english
	\brief		Retrieves parameter type from c++ type.
	\remarks	Specialisation for utils::Point3f.
	\~french
	\brief		Récupère le type de paramètre à partir du type C++.
	\remarks	Spécialisation pour utils::Point3f.
	*/
	template<>
	...
	\~english
	\brief		Retrieves parameter type from c++ type.
	\remarks	Specialisation for utils::Point4f.
	\~french
	\brief		Récupère le type de paramètre à partir du type C++.
	\remarks	Spécialisation pour utils::Point4f.
	*/
	template<>
	...
	\~english
	\brief		Retrieves parameter type from c++ type.
	\remarks	Specialisation for utils::Point2d.
	\~french
	\brief		Récupère le type de paramètre à partir du type C++.
	\remarks	Spécialisation pour utils::Point2d.
	*/
	template<>
	...
	\~english
	\brief		Retrieves parameter type from c++ type.
	\remarks	Specialisation for utils::Point3d.
	\~french
	\brief		Récupère le type de paramètre à partir du type C++.
	\remarks	Spécialisation pour utils::Point3d.
	*/
	template<>
	...
	\~english
	\brief		Retrieves parameter type from c++ type.
	\remarks	Specialisation for utils::Point4d.
	\~french
	\brief		Récupère le type de paramètre à partir du type C++.
	\remarks	Spécialisation pour utils::Point4d.
	*/
	template<>
	...
	\~english
	\brief		Retrieves parameter type from c++ type.
	\remarks	Specialisation for utils::Size.
	\~french
	\brief		Récupère le type de paramètre à partir du type C++.
	\remarks	Spécialisation pour utils::Size.
	*/
	template<>
	...
	\~english
	\brief		Retrieves parameter type from c++ type.
	\remarks	Specialisation for utils::Position.
	\~french
	\brief		Récupère le type de paramètre à partir du type C++.
	\remarks	Spécialisation pour utils::Position.
	*/
	template<>
	...
	\~english
	\brief		Retrieves parameter type from c++ type.
	\remarks	Specialisation for utils::Rectangle.
	\~french
	\brief		Récupère le type de paramètre à partir du type C++.
	\remarks	Spécialisation pour utils::Rectangle.
	*/
	template<>
	...
	\~english
	\brief		Retrieves parameter type from c++ type.
	\remarks	Specialisation for utils::RgbColour.
	\~french
	\brief		Récupère le type de paramètre à partir du type C++.
	\remarks	Spécialisation pour utils::RgbColour.
	*/
	template<>
	...
	\~english
	\brief		Retrieves parameter type from c++ type.
	\remarks	Specialisation for utils::RgbaColour.
	\~french
	\brief		Récupère le type de paramètre à partir du type C++.
	\remarks	Spécialisation pour utils::RgbaColour.
	*/
	template<>
	...
	\~english
	\brief		Retrieves parameter type from c++ type.
	\remarks	Specialisation for utils::HdrRgbColour.
	\~french
	\brief		Récupère le type de paramètre à partir du type C++.
	\remarks	Spécialisation pour utils::HdrRgbColour.
	*/
	template<>
	...
	\~english
	\brief		Retrieves parameter type from c++ type.
	\remarks	Specialisation for utils::HdrRgbaColour.
	\~french
	\brief		Récupère le type de paramètre à partir du type C++.
	\remarks	Spécialisation pour utils::HdrRgbaColour.
	*/
	template<>
