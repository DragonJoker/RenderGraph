...
*/
#ifndef ___Utils_FILE_PARSER_CONTEXT_H___
#define ___Utils_FILE_PARSER_CONTEXT_H___
...
namespace utils
{
	...
	*/
	...
	public:
		 ...
		 */
		explicit FileParserContext( Path const & path );
		/**
		 *\~english
		 *\brief		Destructor.
		 *\~french
		 ...
		 */
		void registerUserContext( String const & name, void * data );
		/**
		 *\~english
		 ...
		 */
		void * unregisterUserContext( String const & name );
		/**
		 *\~english
		 ...
		 *\return		Les données du contexte utilisateur.
		 */
		void * getUserContext( String const & name );
