...
*/
#ifndef ___Utils_ALIGNED_H___
#define ___Utils_ALIGNED_H___
...
namespace utils
{
	...
	*/
	...
	public:
		...
		{
			void * storage = utils::alignedAlloc( AlignValue, p_size );
		...
		{
			return utils::alignedAlloc( AlignValue, p_size );
		}

		void operator delete( void * p_memory )
		{
			utils::alignedFree( p_memory );
		}
