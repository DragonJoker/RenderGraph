...
*/
#ifndef ___Utils_NAMED_H___
#define ___Utils_NAMED_H___
...
namespace utils
{
	...
	\remark		The name type is a template argument so anything can be a name for this class (default is utils::String)
	\~french
	\brief		Classe de base pour les éléments nommés
	\remark		Le nom est un argument template, ainsi n'importe quoi peut être un nom pour cette classe (même si c'est utils::String par défaut)
	*/
