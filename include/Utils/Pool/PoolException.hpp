...
*/
#ifndef ___Utils_POOL_EXCEPTION_H___
#define ___Utils_POOL_EXCEPTION_H___
...
namespace utils
{
	...
	*/
	enum class PoolErrorType
	{
		...
		eSTLAllocatorUnique,
		Utils_ScopedEnumBounds( eCommonOutOfMemory )
	};
...
\date 		03/01/2011
\~english
\brief		Macro to ease the use of utils::PoolException
\~french
\brief		Macro définie pour faciliter l'utilisation de utils::PoolException
*/
#define POOL_EXCEPTION( error ) throw utils::PoolMemoryException< error >( __FILE__, __FUNCTION__, __LINE__ )
