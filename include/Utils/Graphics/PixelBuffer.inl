namespace utils
{
	...
	PxBuffer< FT >::PxBuffer( Size const & p_size, uint8_t const * p_buffer, ashes::Format p_bufferFormat )
		: PxBufferBase( p_size, ashes::Format( FT ) )
	...
	template< ashes::Format FT >
	void PxBuffer< FT >::assign( std::vector< uint8_t > const & p_buffer, ashes::Format p_bufferFormat )
	{
