...
*/
#ifndef ___Utils_GLYPH_H___
#define ___Utils_GLYPH_H___
...
namespace utils
{
	...
	*/
	...
	public:
		 ...
		 *\~english
		 *\brief		Constructor
		 *\param[in]	glyph	The glyph character
		 ...
		 *\~french
		 *\brief		Constructeur
		 *\param[in]	glyph	Le caractère de la glyphe
