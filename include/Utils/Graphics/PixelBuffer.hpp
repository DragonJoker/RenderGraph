...
*/
#ifndef ___Utils_PIXEL_BUFFER_H___
#define ___Utils_PIXEL_BUFFER_H___
...
namespace utils
{
			...
			, Pixel< PF > & >
	{
		...
		inline PixelIterator( array_type const & array
	...
	template< ashes::Format PF >
	inline ConstPixelIterator< PF > operator+( ConstPixelIterator< PF > it
		, size_t offset )
	{
	...
	*/
	...
	public:
		 ...
		 *\return
		 */
		void assign( std::vector< uint8_t > const & buffer, ashes::Format bufferFormat )override;
		/**
		 *\~english
