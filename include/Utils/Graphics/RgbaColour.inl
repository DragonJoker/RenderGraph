#include "Utils/Data/BinaryFile.hpp"
#include "Utils/Data/TextFile.hpp"
...
namespace utils
{
	...
	RgbaColourT< ComponentType >::TextWriter::TextWriter( String const & tabs )
		: utils::TextWriter< RgbaColourT >( tabs )
	{
	}
		...
		, TextFile & file )
	{
		...
		utils::TextWriter< RgbaColourT >::checkError( result, "RgbaColourT value" );
		return result;
	}
