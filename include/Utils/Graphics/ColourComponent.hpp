...
*/
#ifndef ___Utils_COLOUR_COMPONENT_H___
#define ___Utils_COLOUR_COMPONENT_H___
...
namespace utils
{
	...
	\~english
	\brief		Defines a colour PixelComponents (R, G, B or A) to be used in utils::RgbColour or utils::RgbaColour.
	...
	\~french
	\brief		Représente une composante de couleur (R, V, B ou A) pour l'utilisation dans utils::RgbColour ou utils::RgbaColour.
	...
	*/
	 ...
	 */
	bool operator ==( ColourComponent const & p_lhs, ColourComponent const & p_rhs );
	/**
	 *\~english
	 ...
	 *\return		Resultat de p_lhs + p_rhs
	 */
	float operator+( ColourComponent const & p_lhs, ColourComponent const & p_rhs );
	/**
	 *\~english
