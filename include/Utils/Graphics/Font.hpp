...
*/
#ifndef ___Utils_FONT_H___
#define ___Utils_FONT_H___
...
namespace utils
{
	...
	*/
	...
	public:
		...
		*/
		...
		public:
			 ...
			 */
			bool operator()( Font const & p_object, TextFile & p_file )override;
		};
		/*!
		\author		Sylvain DOREMUS
		\version	0.6.1.0
		...
		*/
		class BinaryLoader
			: public utils::BinaryLoader< Font >
		{
		public:
			/**
			 *\~english
			 ...
			 */
			bool operator()( Font & p_font, Path const & p_path, uint32_t p_height );

		private:
			bool operator()( Font & p_font, Path const & p_path );
	...
	public:
		 ...
		 */
		Font( String const & p_name, uint32_t p_height );
		/**
		 *\~english
		 *\brief		Constructor
		 ...
		 *\param[in]	p_height	La hauteur des caractères de la police
		 */
		Font( String const & p_name, uint32_t p_height, Path const & p_path );
		/**
		 *\~english
		 *\brief		Destructor
		 *\~french
