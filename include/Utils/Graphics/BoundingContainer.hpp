...
*/
#ifndef ___Utils_BoundingContainer_H___
#define ___Utils_BoundingContainer_H___
...
namespace utils
{
	...
	*/
	...
	public:
		 ...
		 */
		virtual bool isWithin( Point< real, Dimension > const & point )const = 0;
		/**
		 *\~english
		 ...
		 */
		virtual bool isOnLimits( Point< real, Dimension > const & point )const = 0;
		/**
		 *\~english
