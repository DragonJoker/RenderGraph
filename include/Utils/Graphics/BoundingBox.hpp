...
*/
#ifndef ___Utils_BoundingBox_H___
#define ___Utils_BoundingBox_H___
...
namespace utils
{
	...
	*/
	...
	{
	public:
		BoundingBox( BoundingBox const & rhs ) = default;
		BoundingBox( BoundingBox && rhs ) = default;
		BoundingBox & operator=( BoundingBox const & rhs ) = default;
		 ...
		 */
		BoundingBox( Point3r const & min, Point3r const & max );
		/**
		 *\~english
		 ...
		 */
		BoundingBox getUnion( BoundingBox const & bb )const;
		/**
		 *\~english
		 ...
		 *\param[in]	max	Le point maximal.
		 */
		void load( Point3r const & min, Point3r const & max );
		/**
		 *\~english
		 ...
		 */
		BoundingBox getAxisAligned( Matrix4x4r const & transformations )const;
		/**
		 *\~english
		 ...
		 */
		Point3r getPositiveVertex( Point3r const & normal )const;
		/**
		 *\~english
		 ...
		 */
		Point3r getNegativeVertex( Point3r const & normal )const;
		/**
		 *\~english
