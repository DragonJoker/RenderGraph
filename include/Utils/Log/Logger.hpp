...
*/
#ifndef ___Utils_LOGGER_H___
#define ___Utils_LOGGER_H___
...
namespace utils
{
	...
	*/
	...
	public:
		 ...
		 */
		static void initialise( LogType p_eLogLevel );
		/**
		 *\~english
		 ...
		 */
		static void registerCallback( LogCallback p_pfnCallback, void * p_pCaller );
		/**
		 *\~english
		 ...
		 */
		static void unregisterCallback( void * p_pCaller );
		/**
		 *\~english
		 ...
		 */
		static void setFileName( String const & p_logFilePath, LogType p_eLogType = LogType::eCount );
		/**
		 *\~english
		 ...
		 */
		static void logTrace( std::string const & p_msg );
		/**
		 *\~english
		 ...
		 *\param[in]	p_msg	La ligne a logger
		 */
		static void logTrace( std::ostream const & p_msg );
		/**
		 *\~english
		 ...
		 *\param[in]	p_msg	La ligne a logger
		 */
		static void logTrace( std::wstring const & p_msg );
		/**
		 *\~english
		 ...
		 *\param[in]	p_msg	The line to log
		 */
		static void logTrace( std::wostream const & p_msg );
		/**
		 *\~english
		 ...
		 *\param[in]	p_msg	La ligne a logger
		 */
		static void logInfo( std::string const & p_msg );
		/**
		 *\~english
		 ...
		 *\param[in]	p_msg	The line to log
		 */
		static void logInfo( std::ostream const & p_msg );
		/**
		 *\~english
		 ...
		 *\param[in]	p_msg	The line to log
		 */
		static void logInfo( std::wstring const & p_msg );
		/**
		 *\~english
		 ...
		 *\param[in]	p_msg	The line to log
		 */
		static void logInfo( std::wostream const & p_msg );
		/**
		 *\~english
		 ...
		 *\param[in]	p_msg	La ligne a logger
		 */
		static void logTraceNoNL( std::string const & p_msg );
		/**
		 *\~english
		 *\brief		Logs a trace message, from a std::ostream
		 *\remarks		doesn't print the new line character.
		 ...
		 *\param[in]	p_msg	La ligne a logger
		 */
		static void logTraceNoNL( std::ostream const & p_msg );
		/**
		 *\~english
		 *\brief		Logs a unicode trace message, from a std::wstring
		 *\remarks		doesn't print the new line character.
		 ...
		 *\param[in]	p_msg	La ligne a logger
		 */
		static void logTraceNoNL( std::wstring const & p_msg );
		/**
		 *\~english
		 *\brief		Logs a trace message, from a std::wostream
		 *\remarks		doesn't print the new line character.
		 ...
		 *\param[in]	p_msg	The line to log
		 */
		static void logTraceNoNL( std::wostream const & p_msg );
		/**
		 *\~english
		 *\brief		Logs a debug message, from a std::string
		 *\remarks		doesn't print the new line character.
		 ...
		 *\param[in]	p_msg	La ligne a logger
		 */
		static void logDebugNoNL( std::string const & p_msg );
		/**
		 *\~english
		 *\brief		Logs a debug message, from a std::ostream
		 *\remarks		doesn't print the new line character.
		 ...
		 *\param[in]	p_msg	La ligne a logger
		 */
		static void logDebugNoNL( std::ostream const & p_msg );
		/**
		 *\~english
		 *\brief		Logs a unicode debug message, from a std::wstring
		 *\remarks		doesn't print the new line character.
		 ...
		 *\param[in]	p_msg	La ligne a logger
		 */
		static void logDebugNoNL( std::wstring const & p_msg );
		/**
		 *\~english
		 *\brief		Logs a debug message, from a std::wostream
		 *\remarks		doesn't print the new line character.
		 ...
		 *\param[in]	p_msg	The line to log
		 */
		static void logDebugNoNL( std::wostream const & p_msg );
		/**
		 *\~english
		 *\brief		Logs a message, from a std::string
		 *\remarks		doesn't print the new line character.
		 ...
		 *\param[in]	p_msg	La ligne a logger
		 */
		static void logInfoNoNL( std::string const & p_msg );
		/**
		 *\~english
		 *\brief		Logs a message, from a std::ostream
		 *\remarks		doesn't print the new line character.
		 ...
		 *\param[in]	p_msg	The line to log
		 */
		static void logInfoNoNL( std::ostream const & p_msg );
		/**
		 *\~english
		 *\brief		Logs a message, from a std::wstring
		 *\remarks		doesn't print the new line character.
		 ...
		 *\param[in]	p_msg	The line to log
		 */
		static void logInfoNoNL( std::wstring const & p_msg );
		/**
		 *\~english
		 *\brief		Logs a message, from a std::wostream
		 *\remarks		doesn't print the new line character.
		 ...
		 *\param[in]	p_msg	The line to log
		 */
		static void logInfoNoNL( std::wostream const & p_msg );
		/**
		 *\~english
		 *\brief		Logs a warning, from a std::string
		 *\remarks		doesn't print the new line character.
		 ...
		 *\param[in]	p_msg	The line to log
		 */
		static void logWarningNoNL( std::string const & p_msg );
		/**
		 *\~english
		 *\brief		Logs a warning, from a std::ostream
		 *\remarks		doesn't print the new line character.
		 ...
		 *\param[in]	p_msg	The line to log
		 */
		static void logWarningNoNL( std::ostream const & p_msg );
		/**
		 *\~english
		 *\brief		Logs a warning, from a std::wstring
		 *\remarks		doesn't print the new line character.
		 ...
		 *\param[in]	p_msg	The line to log
		 */
		static void logWarningNoNL( std::wstring const & p_msg );
		/**
		 *\~english
		 *\brief		Logs a warning, from a std::wostream
		 *\remarks		doesn't print the new line character.
		 ...
		 *\param[in]	p_msg	The line to log
		 */
		static void logWarningNoNL( std::wostream const & p_msg );
		/**
		 *\~english
		 *\brief		Logs an error, from a std::string
		 *\remarks		doesn't print the new line character.
		 ...
		 *\param[in]	p_msg		The line to log
		 */
		static void logErrorNoNL( std::string const & p_msg );
		/**
		 *\~english
		 *\brief		Logs an error, from a std::ostream
		 *\remarks		doesn't print the new line character.
		 ...
		 *\param[in]	p_msg	The line to log
		 */
		static void logErrorNoNL( std::ostream const & p_msg );
		/**
		 *\~english
		 *\brief		Logs an error, from a std::wstring
		 *\remarks		doesn't print the new line character.
		 ...
		 *\param[in]	p_msg		The line to log
		 */
		static void logErrorNoNL( std::wstring const & p_msg );
		/**
		 *\~english
		 *\brief		Logs an error, from a std::wostream
		 *\remarks		doesn't print the new line character.
		 ...
		 *\param[in]	p_msg	The line to log
		 */
		static void logErrorNoNL( std::wostream const & p_msg );
		/**
		 *\~english
