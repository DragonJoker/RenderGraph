...
*/
#ifndef ___Utils_BLOCK_TRACKER_H___
#define ___Utils_BLOCK_TRACKER_H___
...
#	define CASTOR_TRACK( fn ) utils::BlockTracker tracker##__LINE__( __FUNCTION__, __FILE__, __LINE__ )
