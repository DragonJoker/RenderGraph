...
*/
#ifndef ___Utils_STRING_H___
#define ___Utils_STRING_H___

#include "Utils/UtilsPrerequisites.hpp"
#include "Utils/Stream/StreamBaseManipulators.hpp"
#include <sstream>
...
namespace utils
{
	...
	*/
	namespace string
	{
		 ...
		 */
		bool isInteger( String const & p_strToTest, std::locale const & p_locale = std::locale() );
		/**
		 *\~english
		 ...
		 */
		bool isFloating( String const & p_strToTest, std::locale const & p_locale = std::locale() );
		/**
		 *\~english
		 ...
		 */
		short toShort( String const & p_str, std::locale const & p_locale = std::locale() );
		/**
		 *\~english
		 ...
		 */
		int toInt( String const & p_str, std::locale const & p_locale = std::locale() );
		/**
		 *\~english
		 ...
		 */
		long toLong( String const & p_str, std::locale const & p_locale = std::locale() );
		/**
		 *\~english
		 ...
		 */
		long long toLongLong( String const & p_str, std::locale const & p_locale = std::locale() );
		/**
		 *\~english
		 ...
		 */
		unsigned short toUShort( String const & p_str, std::locale const & p_locale = std::locale() );
		/**
		 *\~english
		 ...
		 */
		unsigned int toUInt( String const & p_str, std::locale const & p_locale = std::locale() );
		/**
		 *\~english
		 ...
		 */
		unsigned long toULong( String const & p_str, std::locale const & p_locale = std::locale() );
		/**
		 *\~english
		 ...
		 */
		unsigned long long toULongLong( String const & p_str, std::locale const & p_locale = std::locale() );
		/**
		 *\~english
		 ...
		 */
		float toFloat( String const & p_str, std::locale const & p_locale = std::locale() );
		/**
		 *\~english
		 ...
		 */
		double toDouble( String const & p_str, std::locale const & p_locale = std::locale() );
		/**
		 *\~english
		 *\brief		Retrieves a double from a given String
		 *\param[in]	p_str		The String
		 ...
		 *\return		Le double contenu dans le String
		 */
		long double toLongDouble( String const & p_str, std::locale const & p_locale = std::locale() );
		/**
		 *\~english
		 *\brief		Retrieves a short from a given String
		 *\param[in]	p_str		The String
		 ...
		 *\return		Le short contenu dans le String
		 */
		real toReal( String const & p_str, std::locale const & p_locale = std::locale() );
		/**
		 *\~english
		 ...
		 */
		StringArray split( String const & p_str, String const & p_delims, uint32_t p_maxSplits = 10, bool p_bKeepVoid = true );
		/**
		 *\~english
		 ...
		 */
		String & replace( String & p_str, xchar p_find, xchar p_replacement );
		/**
		 *\~english
		 ...
		 *\return			Une référence sur la chaîne modifiée
		 */
		String & replace( String & p_str, String const & p_find, xchar p_replacement );
		/**
		 *\~english
		 ...
		 *\return			Une référence sur la chaîne modifiée
		 */
		String & replace( String & p_str, xchar p_find, String const & p_replacement );
		/**
		 *\~english
		 ...
		 *\return			Une référence sur la chaîne modifiée
		 */
		String & replace( String & p_str, String const & p_find, String const & p_replacement );
		/**
		 *\~english
		 ...
		 */
		String & trim( String & p_str, bool p_bLeft = true, bool p_bRight = true );
		/**
		 *\~english
