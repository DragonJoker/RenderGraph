...
//*************************************************************************************************
	...
	template< typename T, uint32_t Columns, uint32_t Rows >
	inline utils::String & operator<<( utils::String & text, utils::Matrix< T, Columns, Rows > const & matrix )
	{
	...
	template< typename T, uint32_t Columns, uint32_t Rows >
	inline utils::String & operator>>( utils::String & text, utils::Matrix< T, Columns, Rows > & matrix )
	{
		utils::StringStream stream( text );
		stream >> matrix;
		text = stream.str();
		return text;
	}
	...
	inline std::basic_ostream< CharT > & operator<<( std::basic_ostream< CharT > & stream, utils::Matrix< T, Columns, Rows > const & matrix )
	{
	...
	template< typename CharT, typename T, uint32_t Columns, uint32_t Rows >
	inline std::basic_istream< CharT > & operator>>( std::basic_istream< CharT > & stream, utils::Matrix< T, Columns, Rows > & matrix )
	{
		for ( uint32_t i = 0; i < Columns; i++ )
		{
			for ( uint32_t j = 0; j < Rows; j++ )
