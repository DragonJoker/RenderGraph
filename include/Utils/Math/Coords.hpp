...
*/
#ifndef ___Utils_COORDS_H___
#define ___Utils_COORDS_H___

#include "Utils/Data/TextLoader.hpp"
#include "Utils/Data/TextWriter.hpp"
...
namespace utils
{
	...
	*/
	...
	public:
		...
		*/
		class TextLoader
			: public utils::TextLoader< Coords >
		{
		public:
			/**
			 *\~english
		...
		*/
		class TextWriter
			: public utils::TextWriter< Coords >
		{
		public:
			/**
			 *\~english
...
/**@{*/
template< typename T, uint32_t Count >
utils::String & operator<<( utils::String & out, utils::Coords< T, Count > const & in );
template< typename T, uint32_t Count >
utils::String & operator>>( utils::String & in, utils::Coords< T, Count > & out );
template< typename T, uint32_t Count, typename CharType >
std::basic_ostream< CharType > & operator<<( std::basic_ostream< CharType > & out, utils::Coords< T, Count > const & in );
template< typename T, uint32_t Count, typename CharType >
std::basic_istream< CharType > & operator>>( std::basic_istream< CharType > & in, utils::Coords< T, Count > & out );
/**@}*/
