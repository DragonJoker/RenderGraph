...
*/
#ifndef ___Utils_ANGLE_H___
#define ___Utils_ANGLE_H___
...
namespace utils
{
	...
	*/
	...
	public:
		...
		static const Type RadianToGrad;
		...
		static const Type PiMult2;
		//!\~english Pi / 2 constant	\~french Constante pi / 2
		static const Type PiDiv2;
...
inline utils::Angle operator "" _degrees( long double p_value )
{
	return utils::Angle::fromDegrees( p_value );
}

inline utils::Angle operator "" _radians( long double p_value )
{
	return utils::Angle::fromRadians( p_value );
}
