...
namespace utils
{
	namespace
	{
		...
		{
			static inline void inverse( utils::SquareMatrix< Type, 4 > const & input
				, utils::SquareMatrix< Type, 4 > & result )
			{
				auto tS0 = input[0];
				Type tS00 = input[0][0];
				Type tS01 = input[0][1];
				...
				utils::Point< Type, 4 > ptRow0( result[0][0], result[1][0], result[2][0], result[3][0] );
				Type determinant = utils::point::dot( tS0, ptRow0 );
				result /= determinant;
			}
		};
		...
		{
			static inline void inverse( utils::SquareMatrix< Type, 3 > const & input
				, utils::SquareMatrix< Type, 3 > & result )
			{
				Type tS00 = input[0][0];
				Type tS01 = input[0][1];
				Type tS02 = input[0][2];
		...
		{
			static inline void inverse( utils::SquareMatrix< Type, 2 > const & input
				, utils::SquareMatrix< Type, 2 > & result )
			{
		...
		struct SqrMtxOperators< Type, 4 >
		{
			...
			static inline void mul( utils::SquareMatrix< Type, 4 > & lhs, utils::SquareMatrix< Type, 4 > const & rhs )
			{
		...
		struct SqrMtxOperators< Type, 3 >
		{
			...
			static inline void mul( utils::SquareMatrix< Type, 3 > & lhs, utils::SquareMatrix< Type, 3 > const & rhs )
			{
				auto const l11 = lhs[0][0];
				auto const l12 = lhs[0][1];
				auto const l13 = lhs[0][2];
		...
		struct SqrMtxOperators< Type, 2 >
		{
			...
			static inline void mul( utils::SquareMatrix< Type, 2 > const & lhs, utils::SquareMatrix< Type, 2 > const & rhs )
			{
				auto const l11 = lhs[0][0];
				auto const l12 = lhs[0][1];
				auto const l21 = lhs[1][0];
		...
		{
			static inline utils::Point< TypeB, Count > mul( utils::SquareMatrix< TypeA, 4 > const & lhs, utils::Point< TypeB, Count > const & rhs )
			{
				utils::Point< TypeB, Count > result;
		...
		{
			static inline utils::Point< TypeB, 0 > mul( utils::SquareMatrix< TypeA, 4 > const & lhs, utils::Point< TypeB, 0 > const & rhs )
			{
				return utils::Point< TypeB, 0 >();
			}
		};
		...
		{
			static inline utils::Point< TypeB, 1 > mul( utils::SquareMatrix< TypeA, 4 > const & lhs, utils::Point< TypeB, 1 > const & rhs )
			{
				utils::Point< TypeB, 1 > result;
		...
		{
			static inline utils::Point< TypeB, 2 > mul( utils::SquareMatrix< TypeA, 4 > const & lhs, utils::Point< TypeB, 2 > const & rhs )
			{
				utils::Point< TypeB, 2 > result;
		...
		{
			static inline utils::Point< TypeB, 3 > mul( utils::SquareMatrix< TypeA, 4 > const & lhs, utils::Point< TypeB, 3 > const & rhs )
			{
				utils::Point< TypeB, 3 > result;
		...
		{
			static inline T get( utils::SquareMatrix< T, 1 > const & CU_PARAM_UNUSED( matrix ), uint32_t CU_PARAM_UNUSED( column ), uint32_t CU_PARAM_UNUSED( row ) )
			{
				return T{ 1 };
			}
		};
		...
		{
			static inline T get( utils::SquareMatrix< T, Count > const & matrix, uint32_t column, uint32_t row )
			{
				T tReturn = T();
				utils::SquareMatrix < T, Count - 1 > mtxTmp = matrix.getMinor( column, row );
...
//*************************************************************************************************
	...
	inline std::basic_ostream< CharT > & operator<<( std::basic_ostream< CharT > & p_streamOut, utils::SquareMatrix< T, Count > const & p_matrix )
	{
	...
	template< typename CharT, typename T, uint32_t Count >
	inline std::basic_istream< CharT > & operator>>( std::basic_istream< CharT > & p_streamIn, utils::SquareMatrix< T, Count > & p_matrix )
	{
		for ( uint32_t i = 0; i < Count; i++ )
		{
			for ( uint32_t j = 0; j < Count; j++ )
