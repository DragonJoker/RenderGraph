...
namespace utils
{
	...
	*/
	...
	public:
		 ...
		 */
		PlaneEquation( Point3r const & p1
			, Point3r const & p2
			, Point3r const & p3 );
		/**
		 *\~english
		 ...
		 */
		PlaneEquation( Point3r const & normal
			, Point3r const & point );
		/**
		 *\~english
		 *\brief		Constructor.
		 ...
		 */
		bool isParallel( PlaneEquation const & plane )const;
		/**
		 *\~english
		 ...
		 */
		real distance( Point3r const & point )const;
		/**
		 *\~english
		 ...
		 */
		Point3r project( Point3r const & point )const;
		/**
		 ...
		 */
		bool intersects( PlaneEquation const & plane
