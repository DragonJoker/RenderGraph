...
*/
#ifndef ___Utils_POINT_H___
#define ___Utils_POINT_H___
...
/**@{*/
template< typename T, uint32_t TCount >
utils::String & operator<<( utils::String & out, utils::Point< T, TCount > const & in );
template< typename T, uint32_t TCount >
utils::String & operator>>( utils::String & in, utils::Point< T, TCount > & out );
template< typename T, uint32_t TCount, typename CharType >
std::basic_ostream< CharType > & operator<<( std::basic_ostream< CharType > & out, utils::Point< T, TCount > const & in );
template< typename T, uint32_t TCount, typename CharType >
std::basic_istream< CharType > & operator>>( std::basic_istream< CharType > & in, utils::Point< T, TCount > & out );
