...
*/
#ifndef ___Utils_MATRIX_H___
#define ___Utils_MATRIX_H___
...
namespace utils
{
	...
	\remark		Peut contenir n'importe quel élément qui a une utils::Policy.
	*/
	...
	**/
	/**@{*/
	template< typename T, uint32_t Columns, uint32_t Rows >
	utils::String & operator<<( utils::String & stream, utils::Matrix< T, Columns, Rows > const & matrix );
	template< typename T, uint32_t Columns, uint32_t Rows >
	utils::String & operator>>( utils::String & stream, utils::Matrix< T, Columns, Rows > & matrix );
	template< typename CharT, typename T, uint32_t Columns, uint32_t Rows >
	std::basic_ostream< CharT > & operator<<( std::basic_ostream< CharT > & stream, utils::Matrix< T, Columns, Rows > const & matrix );
	template< typename CharT, typename T, uint32_t Columns, uint32_t Rows >
	std::basic_istream< CharT > & operator>>( std::basic_istream< CharT > & stream, utils::Matrix< T, Columns, Rows > & matrix );
	/**@}*/
}
